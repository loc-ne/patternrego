...
class Model(nn.Module):
    def __init__(self, pretrained=True, num_classes=7, drop_rate=0):
        ...
        msceleb_path = os.path.join(args.raf_path, 'resnet18_msceleb.pth')
        if os.path.isfile(msceleb_path):
            ...
            print('Warning: pretrained checkpoint not found at {}. Training will continue with random initialization.'.format(msceleb_path))
